$(function() {
	...
	// Counter
		$('.c-1 .plus, .c-1 .minus, .c-2 .plus, .c-2 .minus, #calcEV, #sos, #remainder').addClass('btn_color')
	...
	$('#mode').click(function() {
		...
		// Counter
			$('.counter, .display input, .calcEV').toggleClass('darker_bg')
			$('.c-1 .plus, .c-1 .minus, .c-2 .plus, .c-2 .minus, #calcEV, #sos, #remainder').toggleClass('btn_color')
			$('.buttons td, #calcEV').toggleClass('dark_bg')
			$('.undoBtn, .reset, #sos, #remainder').toggleClass('light_bg')
	})
